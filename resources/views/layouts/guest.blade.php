...
<!-- Mirrored from maraviyainfotech.com/projects/luxurious-html-v22/luxurious-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 May 2024 13:44:51 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="about_page" role="button"
                                        >
                                        About us
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="about_html">About Us</a>
                                        </li>
                                        <li>
...
<!-- Mirrored from maraviyainfotech.com/projects/luxurious-html-v22/luxurious-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 May 2024 13:45:16 GMT -->
</html>
