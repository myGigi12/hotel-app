            ...
            <div class="row">
                ...
                <div class="col-lg-4 rs-pb-24">
                    <div class="lh-prices" data-aos="fade-up" data-aos-duration="1000">
                        <img src="/storage/{{ $offer->image }}" alt="prices_1" class="prices-image">
                        <div class="lh-prices-out">
                            <div class="lh-prices-in">
                                <h4 class="lh-price-dollar"><span>$</span>{{ $offer->price }}<code> / Per night</code></h4>
                                <h4 class="lh-prices-heading">{{ $offer->name }}</h4>
                            </div>
    ...
    <section class="section-blog bg-gray padding-tb-100">
        <div class="container">
            ...
            <div class="slick-slider blog-slider" data-aos="fade-up" data-aos-duration="2000">
                ...
                <div class="blog-card">
                    <figure><img src="/storage/{{ $blog->image }}" alt="blog-img" class="blog-image-top"></figure>
                    <div class="lh-blog">
                        <div class="lh-blog-date">
                            <span><code>{{$blog->name}}</code> {{$blog->created_at->format('d M Y, h:ia')}} - 05 Comment</span>
                        </div>
                        <a class="top-heding" href="{{route('blog.detail', $blog->id)}}">{{$blog->tittle}}</a>
                    </div>
                </div>
                @endforeach
